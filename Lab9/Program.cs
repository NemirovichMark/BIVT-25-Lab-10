        ...
        public static void Main()
        {
            ...
            for (int i = 0; i < text.Length-1; i++)
            {
                if (char.IsLetter(text[i]) && char.IsLetter(text[i + 1]))
                {
                    ...
                    dve_buk[^1] = text.Substring(i, 2);
                }
            }
            (string, char)[] top = new (string,char)[5];
            var sort = dve_buk
